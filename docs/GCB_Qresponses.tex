...
Most models critical for forecasts assume temperature and light explain forest leafout, but this captures little of the observed variability. We test how light and temperature alongside population-, species- and community-level differences explain leafout variation. %emwNov2: if you need it shorter: Most carbon forecasts or just most forecasts works too, 
...
\textbf{What are three most recently published papers that are relevant to this manuscript?}\\ %emwNov2:  add complete citations
\begin{enumerate}
