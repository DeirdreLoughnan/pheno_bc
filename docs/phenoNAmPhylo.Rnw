...
Species life history events, or phenologies, are advancing with climate change. But climate change impacts are highly variable across space and species, making it challenging to draw generalizations and forecast future responses. Across populations, species can experience different environmental cues, like temperature and daylength, causing phenology to respond to local conditions. But within a community, we find considerable species-level variation, with phenological events occurring over several weeks. The evolutionary history of species further contributes to this species-level variation, reflecting species shared ancestral traits and selection by historic climates. We took a holistic approach to account for this diversity of drivers of phenology and ultimately temporal niche. We focused on budburst phenology of woody plants, as it is well known to respond primarily to winter and spring temperatures, and daylength. Taking a community-level approach, we included 47 woody plant species from four populations across eastern and western North America, performing a growth chamber study in which we varied budbursts three primary cues. Testing the relative importance of cues across species and populations using a Bayesian phylogenetic mixed effects model, we found budburst advanced in response to each cue. But together our cues explained only \Sexpr{diffBAEastHigh} to \Sexpr{diffBAWest}\% of variation. Population-level differences were weak, however, we did find strong phylogenetic structuring of species budburst. These phylogenetic effects suggest an important role of additional, unaccounted for, traits in driving woody plant budburst. Identifying these physiological traits or additional environmental cues contributing to the species-level variation will improve predictions of future phenological shifts and their cascading effects on community dynamics and ecosystem services. 
