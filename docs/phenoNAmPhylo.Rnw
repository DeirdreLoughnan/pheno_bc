...
% EMWJan11 -- 'we do not understand the mechanisms that underlie these trait relationships' feels like maybe too much to add for the reader here, see edits.
% EMWJan2 -- are you keeping the semi-repetitive trait discussion across the two parts of the discussion?
