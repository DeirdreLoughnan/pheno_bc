...
% Evolutionary history adds another piece to the puzzle of temporal assembly of woody plant communities. 
% Evolutionary history and environmental cues are both critical compoenents to temporal assembly of woody plant communities
% Variation in the temporal assembly of woody plant communities shaped equally by evolutionary history as temperature and photoperiod
% Temporal niche of woody plant communities shaped equally by evolutionary history as by current environments.
...
% currently 233
Species life history events, or phenologies, are advancing with climate change. But the impacts of climate change are spatially implicit, and found to have variable effects across species. Understanding the causes of this variability is critical if we are to accurately predict future changes and phenology's cascading effects on communities. We took a more holistic approach to account for the diversity of drives that shape species phenology and temporal niche. Using spring budburst as our study system, we tested the relative importance of population-level variation, species differences, and the potentially confounding effects of phylogenetic structure on phenology across variable temperature and photoperiod cues. We combined budburst data from two growth chamber studies and used a Bayesian phylogenetic mixed effects model to estimate cue responses of 47 woody plant species from four populations across eastern and western North America. While we found weak population-level differences in budburst and cues, there was strong phylogenetic structuring. Cue responses, however, only explained \Sexpr{diffBAEastHigh} to \Sexpr{diffBAWest}\% of variation. The remaining species-level variation suggests there are additional traits driving budburst phenology in woody plant communities. While differences in phenology is largely the result of environmental cue responses, evolutionary history and not geographic differences also plays an important role. Understanding the unidentified drivers of species-level differences, whether they be physiological constraints or other environmental factors, is critical for understanding how future phenological shifts will effect community dynamics and ecosystem services. 
