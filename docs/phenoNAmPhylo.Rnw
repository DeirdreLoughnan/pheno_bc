...
Species life history events, or phenologies, are advancing with climate change. But the impacts of climate change are highly variable across space and species, making it challenging to draw generalizations and forecast future responses. Across populations, species can experience different environmental cues, like temperature and daylength, causing phenology to respond to local conditions. But within a community, we find considerable species-level variation, causing phenological events to occur over several weeks. The evolutionary history of species further contributes to species-level variation, reflecting species shared ancestral traits and the selective pressures imposed by historic climates. We took a holistic approach to account for this diversity of drivers of phenology and ultimately temporal niche. We focused on budburst phenology of woody plants, as it is well known to respond primarily to winter and spring temperatures, and daylength. Taking a community-level approach, we included 47 woody plant species from four populations across eastern and western North America, performing a growth chamber study in which we varied the three primary cues of budburst. Testing the relative importance of cues across species and populations using a Bayesian phylogenetic mixed effects model, we found budburst advanced in response to each cue. But together our cues explained only \Sexpr{diffBAEastHigh} to \Sexpr{diffBAWest}\% of variation. Population-level differences in budburst and cues were weak, however, we did find strong phylogenetic structuring of species budburst. These phylogenetic effects suggest additional, unaccounted for, traits are driving woody plant budburst. Identifying the physiological traits or additional environmental cues contributing to the species-level variation will improve predictions of future phenological shifts and the cascading effects on community dynamics and ecosystem services. 
...
To test for differences in budburst cues across species and populations, we used a phylogenetic mixed effects model with partial pooling across species. This approach accounts for both the evolutionary relatedness of our species, and estimates the species level cues and differences across sites. We obtained species phylogenetic relatedness by pruning the \cite{Smith2018} megatree of angiosperms. \\
...
In our study the assembly of species temporal niche was partly explained by species differences in environmental cues, with little variation explained by differences between populations. Despite our forest populations differing in their species assemblages, and ratio of shrub to tree species, they had similar phenological cues and timing. But in comparing species within communities, we found phenologies to span several weeks. We also found slight gradients in environmental cue responses across each region. For temperate woody plants, the strongest environmental responses were to temperature cues. Our findings support that species phenology is largely shaped by temperature and, to a lesser extent, light. Despite the importance of environmental cues, we also found phenology to have a strong phylogenetic structure. Species evolutionary history contributed almost equally to the phenological variation we observed. We must consider ancestral traits and conditions in addition to current environmental cues if we are to accurately forecast phenological responses under continued warming. \\
...
Still missing from our understanding of budburst phenology are the unidentified latent traits that underlies the observed phylogenetic structure. These latent traits could reflect missed environmental cues or additional traits that mitigate phenological responses to cues. Species temporal niche could be similarly influenced by other physiological or structural traits. Theories of how plants vary in their growth strategies predicts phenology to correlate with other key traits, with some traits facilitating greater resource use and earlier spring growth, and others the greater competitive abilities needed when budbursting later \citep{Grime1977}. For example, we might predict earlier budbursting shrub species to possess photosynthetic machinery that allows them to better use the light available prior to canopy closure in early spring.  Currently, we do not understand the mechanisms that underlie these trait relationships, but incorporating phenology into a broader trait framework could provide insights into the drivers selecting for species phenotypes and forecasting abilities. \\ 
