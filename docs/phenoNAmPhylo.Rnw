...
% 2.Species
While the effects of population-level variation on cue responses appears be negligible, individual species within community do differ in their responses to cue (Fig. \ref{fig:betaAlphaGrad}). We found species budburst responses were dependent on the magnitude of cues experienced. Our model estimated positive effects of cues on budburst under both low and high cue conditions, but with earlier estimated budburst dates under stronger cue conditions (Fig. \ref{fig:betaAlphaGrad}). Temperatures are not change uniformly, however, with higher latitudes experiencing faster rates of temperatures change (citation). This could drive future changes in population-level trends in budburst, as confounding effects of warming temperatures impose varying selection across species distributions.\\
