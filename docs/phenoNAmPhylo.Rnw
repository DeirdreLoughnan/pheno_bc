...
Species life history events, or phenologies, are advancing with climate change. But the impacts of climate change are highly variable across space and species, making it challenging to draw generalizations across species and forecast future responses. Across populations, species can experience different environmental cues, like temperature and daylength, driving differences in phenology in response to local conditions. But within a community, differences in individual species can cause phenologies to span several weeks. The evolutionary history of species within a community further contributes to species-level variation, reflecting species shared ancestral traits and historic climates. We took a holistic approach to account for this diversity of drives that shape species phenology and temporal niche. We focuses here on budburst phenology of woody plants, as it is well known to respond to winter and spring temperatures and daylength. Taking a community approach, we included 47 woody plant species from four populations across eastern and western North America, performing a growth chamber study in which we varied winter and spring temperatures and daylengths. We tested the relative importance of cues across species and populations using a Bayesian phylogenetic mixed effects model. Budburst advanced in response to each of cue. But together our cues explained \Sexpr{diffBAEastHigh} to \Sexpr{diffBAWest}\% of variation. Population-level differences in budburst and cues were weak, however, we did find strong phylogenetic structuring of budburst. These phylogenetic effects suggests additional traits are driving woody plant budburst. Identifying the physiological traits or additional environmental cues contributing to the species-level variation will improve predictions of future phenological shifts and the cascading effects on community dynamics and ecosystem services. 


%We tested the relative importance of population-level variation, species differences, and the potentially confounding effects of phylogenetic structure on phenology across variable temperature and photoperiod cues.

% 24Dec2023emw -- good idea on the ending, but could be shorter and easier to understand. Overall, seems you have a good start, but need to refine the order and especially the language. 
...
%emwDec19 -- tighten up the cue language here (skip cue responses, check what you use above and try to go with it), 
...
Here we combined results from two growth chamber studies of woody species budburst cues. We used data from four populations, from eastern to western North America, with pairs of populations on each coast spanning 4-6$^{\circ}$ latitude. We explored the differences in cues between western and eastern forest communities, and across latitudes. Sampling 47 woody plant species, our dataset includes a diverse assemblage of tree and shrubs. Given known differences in architecture and resource use between canopy and understory species, we expected shrubs to budburst earlier, with weaker overall cue responses. Finally, using a phylogenetic approach allowed us to detect general trends in budburst cues in North American deciduous forest communities, estimating the contribution of species evolutionary history to current variation in species temporal niche. \\ %emwDec19 -- connect shrubs/tree back to resource ... and try to mention temporal niches somehwere in this paragraph if possible
