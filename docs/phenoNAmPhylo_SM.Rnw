...
\begin{figure}[ht]
\centering
    \includegraphics[width= 1 \textwidth]{..//..//pheno_bc/figures/panelFig/intrxnPlots8Chill3Lat.pdf}%,
...
\begin{table}[ht!]
\centering
\caption{Mean day of budburst following the start of forcing treatments, estimated from raw observation data of 47 species at our two western sites, E.C. Manning park and Smithers B.C., Canada, and our two eastern sites, Harvard Forest, USA and St. Hippolyte, Canada.} 
\label{tabPhenoSp}
\begin{tabular}{lrrrr}
  \hline
