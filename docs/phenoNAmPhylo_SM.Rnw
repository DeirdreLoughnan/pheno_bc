...
\begin{figure}[ht]
\centering
    \includegraphics[scale = 0.75]{..//..//pheno_bc/figures/panelFig/intrxnPlots8Chill3Lat.pdf}%,
...
\begin{figure}[h!]
    \centering
     \includegraphics[width=\textwidth]{..//..//pheno_bc/figures/panelFig/cueST28Chill_90.pdf}
