...
\begin{figure}[h!]
    \centering
     \includegraphics[width=\textwidth]{..//..//pheno_bc/figures/cueST28Chill_90.pdf}
...
\begin{figure}[ht]
\centering
  \includegraphics[width= \textwidth]{..//..//pheno_bc/figures/rankstiBBTransect.pdf}%,
