...
\begin{figure}[h!]
    \centering
     ...
     \caption{The difference in budburst ranking between high and low cues for the three species that occurr in both the eastern (shown in green) and western transect (shown in purple). }
