...
\begin{figure}[h!]
    \centering
     \includegraphics[width=\textwidth]{..//figures/changes_pheno_4sitesApril19.pdf}
...
\begin{figure}[h!]
    \centering
     \includegraphics[width=\textwidth]{..//figures/cueSpApril19.pdf}
...
\begin{figure}[h!]
    \centering
     \includegraphics[width=\textwidth]{..//figures/cueST2April19.pdf}
