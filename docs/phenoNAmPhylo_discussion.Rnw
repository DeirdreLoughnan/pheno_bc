...
%EMWNov6: maybe print out and edit by pen for wordiness, such as: we lack a sufficient understanding of the 
...
We also found no latitudinal gradients across populations despite differences in local photoperiods (Fig \ref{fig:siteCues}). This finding contrasts the findings of previous work in which poleward populations experienced later budburst (Lieth1974, Zettlemoyer2021). %EMWNov6: can you add a sentence guessing at why you saw differences? I don't know the other studies, but usually I can think of methodological differences (sampling later when chilling might matter already, or using observational data where teasing out photoperiod is harder ... 
...
Within our forest communities, species varied in their timing of budburst by several weeks, but whether these temporal differences across species will persist with climate change depends on phenological responses across different spatial scales, from the level of the individual regional scales. The similarity spring phenology we found across populations suggests there is little change in the community level response to local habitats. This may indicate strong niche conservatism within species, with ....define niche conservatism....\\


For us to accurately forecast shifts in spring phenology and changes in growth patterns will depend on our understanding of cue responses at the population, species and community levels.
% 1. Population
If species within our populations experience high inter-annual variability in climate, having a consistent response to environmental cues would still allow them to optimize their budburst timing across years and at large spatial scales. 

The lack of population-level differences we observed may be driven by high inter-annual variability in climate. Species that experience high variation in climate benefit from Species that consistenly respond to one set of cues may ben


pecies that consistently respond to a set of environmental cues may benefitexhibit consist phenotypes across habitatsrespond to one set of cues hat selects for the optimal timing of budburst across years and at large spatial scales


as it would be advantageous for species to respond to one set of cues that selects for the optimal timing of budburst across years and at large spatial scales. While the effects of population-level variation on cue responses appears be negligible, individual species within community assemblages do differ in their responses to cue (Fig 5). Species' budburst responses were dependent on the magnitude of cues experienced. 
