...
Understanding and explaining this variability is an important goal that remains extremely challenging. While some degree of this variability is likely due to differences in climate change itself across space---as some areas have warmed faster than others and thus may generate larger phenological shifts \citep{IPCC2018}---this generally explains a limited amount of the total variation. In contrast, species-level differences in phenology may explain substantial variation \citep{Vitasse2009, Wolkovich2014, Zohner2014, Vitasse2018}, but we still have limited understanding of how it compares to other potential major sources of variation, including from the population-level and climate. Understanding the role and scale of species-level variation, however is necessary to predict future changes in phenology, and ultimately, its impacts on community dynamics and ecosystem services, including carbon cycles and pollination \citep{Gotelli1996,Cleland2007,Richardson2009}.
\\
