...
\item Removing these four western species does change several of the model estimates. While most parameter estimates are within 15\% of full model, estimates for the forcing x photoperiod interactions is considerably different, while the estimates and interactions for Manning Park, and the interaction with Manning Park and both chilling and photoperiod are considerably different. 
\end{enumerate}
...
\item The interaction between photoperiod and our eastern sites in contrast support a moderate advancing effect, with longer photoperiods at our eastern sites causing budburst dates to advance (Fig. \ref{fig:intrxn} d).
\item While there are some differences across sites, they are weak when site effects are accounted for (Fig. \ref{siteCues})
\item We also did not observe differences across different plant architectures (Fig. \ref{fig:cueST})
...
\item We found different trends in cue use when comparing the timing of first lateral budburst and 50\% lateral budburst for our western species.
\begin{enumerate}
...
\item Our more southern site in our western transect, Manning Park, showed delayed budburst relative to our more northern Smithers sites. 
\item While we do observe weak interactions between photoperiod and Manning Park and chilling and Manning park, a strong advancing interactions occurred between forcing and Manning Park.
%DLOct14 - I think this needs a figure, but in the supp
\end{enumerate}


\item Individual species show more distinct trends 
\begin{enumerate}
\item Across all our focal species, cue responses were strongest for chilling and forcing compared to photoperiod, but species varied in the relative imporatnce of each cue, with thier own unique temporal niche.
\item Weak trends for each cue, with later budburst in species with stronger responses to high chilling, forcong and photoperiod cues (\ref{fig:cuedobb}) - This should be tested quantitiatively 
\item understory species, such as Corsto had both weak chilling and forcing cues, while tree speces such as quevel had stroner chilling and forcing cues as well as photoperiod
\item faggra ahd the strongest photoperiod response, but surprisingly symalb (a shrub had the strongest chilling response).
\end{enumerate}
