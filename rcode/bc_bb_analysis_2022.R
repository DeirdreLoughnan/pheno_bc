...
mdl.t <- stan("stan/lday_site_sp_chill_inter_poola_ncpwp_2chill_sitefixed.stan", 
              data = datalist,
              iter = 2000, warmup = 1000, chains=4
             # , control = list(adapt_delta = 0.99)
              )
save(mdl.t, file="output/tbb_ncpint_ncpwp_2chillport.Rda")
...
save(mdl.t, file="output/tbb_ncpint_ncpwp_2chillport.Rda")
load("output/tbb_ncpint_ncpwp_2chillport.Rda")
...
mdl.lat50 <- stan("stan/lday_site_sp_chill_inter_poola_ncpwp_2chill_sitefixed.stan", 
              data = datalist.50,
              iter = 2000, warmup = 1000, chains=4
              # , control = list(adapt_delta = 0.99)
)
save(mdl.lat50, file="output/l50_ncpint_ncpwp_2chillport.Rda")
...
mdl.1l <- stan("stan/lday_site_sp_chill_inter_poola_ncpwp_2chill_sitefixed.stan", 
                            data = datalist.1,
                            iter = 2000, warmup = 1000, chains=4
                            # , control = list(adapt_delta = 0.99)
)
save(mdl.1l, file="output/l1_ncpint_ncpwp_2chillport.Rda")
