...
pheno$force.n[pheno$force.n == "HF"] <- "20"
pheno$force.n[pheno$force.n == "LF"] <- "15"
...
mdl.4phyloCont <- stan("stan/df_mdl_4sites_again_allint_ncp_phylogeny.stan",
              data = datalist.z2,
              iter = 6000, warmup =4000, chains=4,
              include = FALSE, pars = c("ypred_new","y_hat")
              #, control = list(adapt_delta = 0.99)
)
save(mdl.4phyloCont, file="output/bb_4sites_phylo_contin.Rda")
...
sumC <- summary(mdl.4phyloCont)$summary
phyloC <- summary(mdl.4phyloCont)$summary[c(
  "a_z",
  "lam_interceptsa",
  "mu_b_warm",
  "mu_b_photo",
...
plot(phylo, phyloC, xlim = c(-18,18),ylim=c(-18,18), xlab = "factor model", ylab = "continuous model")
abline(0,1)
# 
...
a_sp = sumt[grep("a_sp", rownames(sumt)), 1]
b_warm = sumt[grep("b_warm", rownames(sumt)), 1];
b_inter_s2c1 = sumt[grep("b_inter_s2c1", rownames(sumt)), 1]

a_spC = sumC[grep("a_sp", rownames(sumC)), 1]
b_warmC = sumC[grep("b_warm", rownames(sumC)), 1]
b_inter_s2c1C = sumC[grep("b_inter_s2c1", rownames(sumC)), 1]

plot(a_sp, a_spC, xlim = c(8,50),ylim=c(8, 50), xlab = "factor a_sp", ylab = "continuous a_sp")
abline(0,1)

plot( b_warm[2:48],  b_warmC[2:48], xlim = c(-18,5),ylim=c(-18, 5), xlab = "factor b_warm", ylab = "continuous b_warm")
abline(0,1)

plot(b_inter_s2c1[2:48], b_inter_s2c1C[2:48], xlim = c(-45,70),ylim=c(-45,70), xlab = "factor b_inter_s2c1", ylab = "continuous b_inter_s2c1")
abline(0,1)
...
# 
# pdf("yrepvsypred_4site_stand_phylo.pdf")
...
# 
# ############################################################
# # Double check the priors:
# h1 <- hist(rnorm(1000, 5,10))
# h2 <- hist(post$a_z)
...
# plot(h2, col=rgb(0,0,1,1/4), xlim = c(0, 5))
# plot(h1, col=rgb(1,0,1,1/4), add = T)
# 
...
# h2 <- hist(post$mu_b_warm)
# plot(h2, col=rgb(0,0,1,1/4), xlim = c(-200, 200))
# plot(h1, col=rgb(1,0,1,1/4), add = T)
# 
# h1 <- hist(rnorm(1000, 0,35))
...
# h2 <- hist(post$b_site2)
# plot(h2, col=rgb(0,0,1,1/4), xlim = c(-50, 50))
# plot(h1, col=rgb(1,0,1,1/4), add = T)
# 
# h1 <- hist(rnorm(1000, 0,5))
# h2 <- hist(post$b_site3)
# plot(h2, col=rgb(0,0,1,1/4), xlim = c(-50, 50))
# plot(h1, col=rgb(1,0,1,1/4), add = T)
# 
# h1 <- hist(rnorm(1000, 0,5))
# h2 <- hist(post$b_site4)
# plot(h2, col=rgb(0,0,1,1/4), xlim = c(-50, 50))
# plot(h1, col=rgb(1,0,1,1/4), add = T)
# 
# h1 <- hist(rnorm(1000, 0,10))
# h2 <- hist(post$sigma_b_warm)
# plot(h2, col=rgb(0,0,1,1/4), xlim = c(-50, 50))
# plot(h1, col=rgb(1,0,1,1/4), add = T)
# 
# h1 <- hist(rnorm(1000, 0,10))
# h2 <- hist(post$sigma_b_chill1)
# plot(h2, col=rgb(0,0,1,1/4), xlim = c(-50, 50))
# plot(h1, col=rgb(1,0,1,1/4), add = T)
# 
# h1 <- hist(rnorm(1000, 0,10))
# h2 <- hist(post$sigma_b_photo)
# plot(h2, col=rgb(0,0,1,1/4), xlim = c(-50, 50))
# plot(h1, col=rgb(1,0,1,1/4), add = T)
# 
# h1 <- hist(rnorm(1000, 0,10))
# h2 <- hist(post$sigma_b_inter_ws2)
# plot(h2, col=rgb(0,0,1,1/4), xlim = c(-50, 50))
# plot(h1, col=rgb(1,0,1,1/4), add = T)
