...
smsstrt<-subset(smss, treatment == "HC_HP_HF"); unique(smsstrt$lab)
smss88trt<-subset(smss88, treatment == "HC_HP_HF"); unique(smss88trt$lab)
#"mp_HC_HP_HF_41_poptre"

#################################################################
#shecan
smss<-subset(temp0, species=="shecan" & population == "sm")
table(smss$treatment)

smss88<-subset(temp88, species=="shecan" & population == "sm")
table(smss88$treatment)
...
smsstrt<-subset(smss, treatment == "LC_LP_HF"); unique(smsstrt$lab)
smss88trt<-subset(smss88, treatment == "LC_LP_HF"); unique(smss88trt$lab)

#################################################################
#sorsco
smss<-subset(temp0, species=="sorsco" & population == "sm")
...
smss<-subset(temp0, species=="spibet" & population == "sm")
table(smss$treatment)
#LHH has one extra for mp and for in LHH flask 38
mpss<-subset(temp0, species=="spibet" & population == "mp")
table(mpss$treatment)

smsstrt<-subset(smss, treatment == "LC_HP_HF"); unique(smsstrt$lab)
mpsstrt<-subset(mpss, treatment == "LC_HP_HF"); unique(mpsstrt$lab)
# there was alwasy an extra spibet in mp

smss<-subset(temp88, species=="spibet" & population == "sm")
table(smss$treatment)
#LHH has one extra for mp and for sm
mpss<-subset(temp88, species=="spibet" & population == "mp")
table(mpss$treatment)
#################################################################
#vibedu

smss<-subset(temp0, species=="vibedu" & population == "sm")
table(smss$treatment)

smss88<-subset(temp88, species=="vibedu" & population == "sm")
table(smss88$treatment)
...
#################################################################
#acegla
smss<-subset(temp0, species=="acegla" & population == "sm")
table(smss$treatment)

smss88<-subset(temp88, species=="acegla" & population == "sm")
table(smss88$treatment)
...
#################################################################
#corsto
smss<-subset(temp0, species=="corsto" & population == "sm")
table(smss$treatment)

smss88<-subset(temp88, species=="corsto" & population == "sm")
table(smss88$treatment)

smsstrt<-subset(smss, treatment == "HC_LP_LF"); unique(smsstrt$lab)
smss88trt<-subset(smss88, treatment == "HC_LP_LF"); unique(smss88trt$lab)

mss<-subset(temp0, species=="corsto" & population == "mp")
table(mss$treatment)

mss88<-subset(temp88, species=="corsto" & population == "mp")
table(mss88$treatment)

msstrt<-subset(mss, treatment == "HC_LP_LF"); unique(msstrt$lab)
mss88trt<-subset(mss88, treatment == "HC_LP_LF"); unique(mss88trt$lab)

hhh<-subset(mss88, treatment=="HC_HP_HF")
hh<-subset(mss, treatment=="HC_HP_HF")
#################################################################
#loninv
smss<-subset(temp0, species=="loninv" & population == "mp")
table(smss$treatment)

smss88<-subset(temp88, species=="loninv" & population == "mp")
table(smss88$treatment)
...
#################################################################
#rubpar
smss<-subset(temp0, species=="rubpar" & population == "mp")
table(smss$treatment)

smss88<-subset(temp88, species=="rubpar" & population == "mp")
table(smss88$treatment)
