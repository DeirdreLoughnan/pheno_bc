...
pdf("figures/site4CueGrouped8Chill32.pdf", width = 12, height =4)
ggplot() + 
...
ggplot() + 
  stat_eye(data = longest, aes(x = factor(site, level = siteOrder), y = value, fill = cue, group = cue), .width = c(1,.90, .5), cex = 0.75, position = position_dodge(0.9)) +
  ylim (-45,10) +
  theme_classic() +   
  theme(legend.position = "right", 
