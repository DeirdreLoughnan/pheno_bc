...
//	mu_photo ~ normal(0, 40);
	...
	mu_b_inter_fp ~ normal(0, 35);
	mu_b_inter_fs ~ normal(0, 35);
	mu_b_inter_ps ~ normal(0, 35);
	mu_b_inter_fc ~ normal(0, 35);		
	mu_b_inter_pc ~ normal(0, 35);	
	mu_b_inter_sc ~ normal(0, 35);	
...
//	b_photo ~ normal(mu_photo, sigma_photo);
	...
	b_inter_fp ~ normal(mu_b_inter_fp, sigma_b_inter_fp); // Delete because all in NCP now
	b_inter_fs ~ normal(mu_b_inter_fs, sigma_b_inter_fs);
	...
	b_inter_sc ~ normal(mu_b_inter_sc, sigma_b_inter_sc);	
