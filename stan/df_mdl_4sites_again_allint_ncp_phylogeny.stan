...
data {
 ...
 transformed data { 	      // 9 interaction terms
  ...
  site2_std = (site2-mean(site2))/(2*sd(site2)); 
  site3_std = (site3-mean(site3))/(2*sd(site3)); 
  site4_std = (site4-mean(site4))/(2*sd(site4)); 

  inter_wp    = warm_std .* photo_std;
  inter_wc1    = warm_std .* chill1_std;
  inter_pc1    = photo_std .* chill1_std;

  inter_ws2    = warm_std .* site2_std;
  inter_ws3    = warm_std .* site3_std;
  inter_ws4    = warm_std .* site4_std;
  inter_ps2    = photo_std .* site2_std;
  inter_ps3    = photo_std .* site3_std;
  inter_ps4    = photo_std .* site4_std;
  inter_s2c1    = chill1_std .* site2_std;
  inter_s3c1    = chill1_std .* site3_std;
  inter_s4c1    = chill1_std .* site4_std;
