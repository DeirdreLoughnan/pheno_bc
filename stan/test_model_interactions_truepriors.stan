...
// Feb 4: still getting divergent transitions, but it looks to be due to issues with fp - has a banana shape - add ncp
...
model {
  ...
  mu_grand ~ normal(50, 20);
	...
	sigma_force ~ normal(10, 1); 
	sigma_photo ~ normal(10, 1); 
	sigma_chill ~ normal(10, 1);
	sigma_a ~ normal(10,5);
	sigma_y ~ normal(20,5);
